...
import { faHome, faChevronRight, faTimes, faExclamationTriangle, faTrash, faPen, faSave, faPlusCircle } from "@fortawesome/free-solid-svg-icons";
...
const AdminFinance = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKEND_URL}/backoffice/admin_finance.php`)
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`${process.env.REACT_APP_BACKEND_URL}/backoffice/admin_finance.php`, {
      ...
      .then(({ status, data, message }) => {
        ...
        togglePopup("add");
        setNewTransaction({ deskripsi: "", jumlah: "", tanggal: "" });
      });
  };
  ...
  const handleDelete = (id) => {
    ...
    if (selectedDeleteTransaction == null) return;

    fetch(
      `${process.env.REACT_APP_BACKEND_URL}/backoffice/admin_finance.php`,
      {
        method: "DELETE", // Mengubah ke metode DELETE
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
  ...
  const confirmUpdate = (transaction) => {
    togglePopup("edit");
  ...
  const submitUpdateTransaction = async (e) => {
    e.preventDefault();
    try {
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Kelola dan pantau semua transaksi keuangan perusahaan. Halaman ini memungkinkan Anda untuk mencatat, mengubah, dan menghapus data transaksi secara efisien.
            </p>
          </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md md:col-span-2 border">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-sm text-white px-3 py-1 rounded ml-2"
                >
              ...
              <div className="overflow-x-auto border border-gray-200 rounded-lg">
                <table className="w-full border-collapse rounded-lg overflow-hidden shadow">
                  <thead className="bg-gray-100 text-gray-700 text-sm tracking-wide">
                    <tr>
                  ...
                  <tbody className="bg-white text-gray-700">
                    {currentTransactions.map((transaction, index) => (
                      <tr
                        key={transaction.id}
                        className="border-b hover:bg-gray-50 transition-colors duration-200 text-sm font-montserrat"
                      >
                        ...
                        <td className="px-4 py-3 text-center">
                          Rp. {Number(transaction.jumlah).toLocaleString("id-ID", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </td>
                        <td className="px-4 py-3 text-center">
                          {transaction.tanggal}
                        </td>
                        <td className="px-4 py-3 text-center">
                          <div className="flex items-center justify-center gap-3">
                            <button
                              onClick={() => confirmUpdate(transaction)}
                              title="Edit"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div>
                        ...
                        <input
                          ...
                          name="deskripsi"
                          value={newTransaction.deskripsi}
                    ...
                    >
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
                          name="deskripsi"
                          value={editingTransaction.deskripsi}
